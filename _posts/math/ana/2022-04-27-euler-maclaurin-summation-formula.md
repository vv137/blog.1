...
(n+1)^5 - 1 &= 5 \sum ^n _{k=1} k^4 + 10 \sum ^n _{k=1} k^3 + 10 \sum ^n _{k=1} k^2 + 5 \sum ^n _{k=1} k + n
.\end{aligned}$$
...
$$\frac{e^x-1}{x} = \frac{1}{x} \sum ^\infty _{k=1} \frac{x^k}{k!} = \sum ^\infty _{k=0} \frac{x^k}{(k+1)!} = 1 +
\frac{x}{2} + \frac{x^2}{6} + \frac{x^3}{24} + \cdots$$
...
\nonumber
1 &= \frac{x}{e^x-1} \frac{e^x-1}{x} = \left( 1 + \frac{x}{2} + \frac{x^2}{6} + \frac{x^3}{24} + \cdots \right) \left(
B_0 + B_1 x + \frac{B_2}{2} x^2 + \cdots \right) \\
&= B_0 + \left( \frac{B_0}{2!0!} + \frac{B_1}{1!1!} \right) x + \left( \frac{B_0}{3!0!} + \frac{B_0}{2!1!} +
\frac{B_0}{1!2!} \right) x^2 + \cdots .\end{aligned}$$
...
$$\hat{T} f(x) = \sum ^\infty _{n=0} \frac{1}{n!} \left( \hat{D}^n f(x) \right) = \sum ^\infty _{n=0} \frac{1}{n!}
\frac{d^n f}{dx^n} .$$
...
&= \left( 1 + \hat{T} + \hat{T}^2 + \cdots \right) f(x) = \frac{1}{1-\hat{T}} f(x) = \frac{1}{1-e^{\hat{D}}} f(x)
.\end{aligned}$$
Treating $\hat{D}$ as an ordinary variable, and using Bernoulli numbers,
we obtain the expression: $$\begin{aligned}
\nonumber
\frac{1}{1-e^{\hat{D}}} &= -\frac{1}{\hat{D}} \frac{\hat{D}}{e^{\hat{D}}-1} = -\frac{1}{\hat{D}} \left( 1 - \frac{1}{2}
\hat{D} + \sum ^\infty _{n=2} \frac{B_n}{n!} \hat{D}^n \right) \\
...
\sum ^\infty _{n=0} f(x+n) = \int ^\infty _x f(x) \; dx + \frac{1}{2} f(x) - \sum ^\infty _{n=2} \frac{B_n}{n!}
\frac{d^{n-1}}{dx^{n-1}} f(x) .$$
...
\nonumber
&- \sum ^\infty _{n=2} \frac{B_n}{n!} \left[ \frac{d^{n-1}}{dx^{n-1}} f(x) \right] _{x=n} + \sum ^\infty _{n=2}
\frac{B_n}{n!} \left[ \frac{d^{n-1}}{dx^{n-1}} f(x) \right] _{x=N} \\
\nonumber
...
$$\sum ^n _{k=1} k^3 = \frac{n^4}{4} + \frac{n^3}{2} + \frac{1}{6} \frac{3!}{2!2!} n^{3-2+1} + 0 = \frac{n^4 + 2n^3 +
n^2}{4} = \left( \frac{n(n+1)}{2} \right) ^2 .$$
...
$$\begin{aligned}
\nonumber
\sum ^n _{k=1} k^4 &= \frac{n^5}{5} + \frac{n^4}{2} + \frac{1}{6} \frac{4!}{2!3!} n^{4-2+1} - \frac{1}{30} \frac{4!}{4!
1!} n^{4-4+1} \\
